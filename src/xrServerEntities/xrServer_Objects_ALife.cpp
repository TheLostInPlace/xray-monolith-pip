...
void	SFillPropData::load			()
    ...
    // story names
	{
		...
		xr_sort				(story_names.begin(),story_names.end(),story_name_predicate());
    ...
    // spawn story names
	{
		...
		xr_sort				(spawn_story_names.begin(),spawn_story_names.end(),story_name_predicate());
	...
	xr_sort(character_profiles.begin(), character_profiles.end(), SortStringsByAlphabetPred);
#endif // AI_COMPILER
...
// destroy ini
	...
	xr_sort				(smart_covers.begin(), smart_covers.end(), logical_string_predicate());
};
