...
void CHOM::Load()
{
	...
	Device.seqParallelRender.push_back(xr_delegate(this, &CHOM::MT_RENDER));
}
...
void CHOM::Unload()
{
	...
	auto I = std::find(Device.seqParallelRender.begin(), Device.seqParallelRender.end(), xr_delegate(this, &CHOM::MT_RENDER));
